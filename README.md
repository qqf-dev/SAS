...
* 每个文件夹下 **doc**文件夹用来储存课堂ppt和相关资料。
* 每个文件夹下的**MATLAB**脚本（.m文件）或其他文件储存在相应的代码文件夹，规则如下：**"ex"** 是课堂练习，**"work"** 是作业相关，**"part"** 是project相关。
* 在每个代码文件夹的后面会有如 **"-\*"** 的结构用来表示作者。像是 "-q" 就是指 "qqf-dev" 所编辑的。
* **lab**文件
* 在project文件夹里，**"code"** 用来存 **MATLAB** 代码, **"figure"** 用来存图片, **"pre"** 用来存报告。
* 在**main**分支的project文件夹里，应该只有一个版本的脚本代码，主要代码命名遵循 **"part-n"** （n表示代码工作部分，按照任务计划来）这样的规则。
*
